...
from emf.loadflow_tool.model_merger import (CgmModelComposer, get_models, PROCESS_ID_KEYWORD,
                                            ...
                                            IMPORT_TSO_LOCALLY_KEYWORD, MODELS_KEYWORD, TASK_KEYWORD)
...
class HandlerGetModels:
    ...
    def __init__(self,
                 ...
                 cgm_minio_bucket: str = PY_EMF_OS_MINIO_OPDE_MODELS_BUCKET,
                 cgm_minio_prefix: str = PY_EMF_OS_MINIO_OPDE_MODELS_FOLDER,
...
class HandlerMergeModels:
    ...
    def __init__(self,
        ...
        :param debugging: debugging regime
        """
        self.debugging = debugging
...
class HandlerPostMergedModel:
    ...
    def __init__(self,
                 ...
                 minio_bucket: str = PY_EMF_OS_MINIO_OPDE_MODELS_BUCKET,
                 folder_in_bucket: str = PY_EMF_OS_MINIO_OPDE_MODELS_FOLDER,
                 save_to_local_storage: bool = EMF_OS_CGM_SAVE_LOCAL_STORAGE,
...
if __name__ == "__main__":
    ...
    testing_local_import = ['LITGRID']
    start_date = parse_datetime("2024-05-21T00:30:00+00:00")
    end_date = parse_datetime("2024-05-22T00:00:00+00:00")
    ...
    for testing_scenario_date in testing_scenario_dates:
        ...
        message_handlers = [HandlerGetModels(debugging=False),
                            HandlerMergeModels(debugging=True),
